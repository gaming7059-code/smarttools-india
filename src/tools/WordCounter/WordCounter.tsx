  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {/* Words */}
        <div className="rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50/80 to-white p-4 shadow-2xs dark:border-blue-900/50 dark:from-blue-950/40 dark:to-slate-900 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md">
        ...
        {/* Characters (all) */}
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-2xs dark:border-slate-800 dark:bg-slate-900 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md">
        ...
        {/* Reading Time */}
        <div className="rounded-2xl border border-amber-200 bg-amber-50/60 p-4 shadow-2xs dark:border-amber-900/50 dark:bg-amber-950/30 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md">
      ...
      {/* Main Textarea Card */}
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden dark:border-slate-800 dark:bg-slate-900 transition-all duration-200 focus-within:border-blue-500 focus-within:ring-3 focus-within:ring-blue-500/15">
        {/* Action Header Bar */}
