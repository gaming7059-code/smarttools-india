  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm space-y-6">
      ...
      <div className="space-y-5">
        {/* Amount Input */}
        <div>
          <label htmlFor="gstAmountInput" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
        ...
        <div>
          <label htmlFor="customGstRate" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
            GST Tax Slab Rate (%)
          </label>
          ...
          <div className="relative max-w-xs">
            ...
            />
            <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 font-semibold text-xs">%</span>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6 pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
              ...
              <div className="text-[11px] text-slate-400 mt-0.5">Central GST</div>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
              ...
              <div className="text-[11px] text-slate-400 mt-0.5">State GST / UTGST</div>
            </div>
          </div>

          <div className="flex items-start gap-2 rounded-xl bg-slate-100/70 p-3 text-xs text-slate-600">
        ...
        <div className="space-y-6 pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
              ...
              <div className="text-[11px] text-slate-400 mt-0.5">Central GST portion</div>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-2xs">
              ...
              <div className="text-[11px] text-slate-400 mt-0.5">State GST portion</div>
            </div>
          </div>
