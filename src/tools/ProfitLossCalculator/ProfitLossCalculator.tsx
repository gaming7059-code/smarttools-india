      ...
      {mode === 'calculateResult' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Cost Price */}
            <div>
              <label htmlFor="costPrice1" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
                Cost Price (CP in ₹)
              </label>
            ...
            {/* Selling Price */}
            <div>
              <label htmlFor="sellingPrice1" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
                Selling Price (SP in ₹)
              </label>
              <div className="relative">
                <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 font-semibold text-sm">₹</span>
            ...
            <div className={`rounded-2xl border p-6 sm:p-8 space-y-6 ${
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="text-xs font-semibold uppercase text-slate-500">Margin / Return</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-3 border-t border-slate-200/80">
                <div className="rounded-xl bg-white p-4 border border-slate-200/90 shadow-2xs">
                  <span className="text-xs font-medium text-slate-500 uppercase tracking-wider">Cost Price (CP)</span>
                ...
                <div className="rounded-xl bg-white p-4 border border-slate-200/90 shadow-2xs">
                  <span className="text-xs font-medium text-slate-500 uppercase tracking-wider">Selling Price (SP)</span>
                  <div className="text-lg font-bold text-slate-900 mt-1">
      ...
      {mode === 'calculateTargetPrice' && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Cost Price */}
            <div>
              <label htmlFor="costPrice2" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
                Cost Price (CP in ₹)
              </label>
              <div className="relative">
                <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 font-semibold text-sm">₹</span>
            ...
            {/* Target Profit % */}
            <div>
              <label htmlFor="targetProfitPercent" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
          ...
          {result2?.success && result2.data ? (
            <div className="rounded-2xl bg-gradient-to-br from-emerald-50/90 via-slate-50 to-blue-50/40 border border-emerald-200 p-6 sm:p-8 space-y-6">
              <div>
