    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm space-y-6">
      ...
      <div className="space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label htmlFor="annualCTC" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
          {/* Basic % */}
          <div>
            <label htmlFor="basicPercent" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
              Basic Salary (% of CTC)
            </label>
            <div className="relative">
              <input
                ...
                placeholder="50"
                className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-sm font-medium text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
              />
          ...
          {/* HRA % */}
          <div>
            <label htmlFor="hraPercent" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
              HRA (% of Basic)
            </label>
            <div className="relative">
              <input
          ...
          {/* Other Allowances */}
          <div>
            <label htmlFor="otherAllowances" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="5000"
                className="w-full rounded-xl border border-slate-200 bg-white pl-7 pr-3.5 py-2 text-sm font-medium text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
              />
            </div>
          </div>
          ...
          {/* Employee PF % */}
          <div>
            <label htmlFor="employeePFPercent" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
          ...
          {/* Professional Tax */}
          <div>
            <label htmlFor="professionalTax" className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5">
      ...
      {salaryResult?.success && salaryResult.data ? (
        <div className="space-y-6 pt-2">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-emerald-50/90 via-slate-50 to-blue-50/40 border border-emerald-200 p-6 sm:p-8">
            <span className="text-xs font-semibold uppercase tracking-wider text-emerald-800">
              Estimated Monthly In-Hand / Take-Home Pay
            </span>
            <div className="mt-1 text-3xl sm:text-5xl font-black text-emerald-950 tracking-tight">
              {formatINR(salaryResult.data.estimatedMonthlyTakeHome, { showDecimals: true })}
            </div>
            <div className="mt-2 text-xs sm:text-sm text-slate-600 flex flex-wrap items-center gap-3">
            ...
            <table className="w-full text-left text-xs sm:text-sm">
              ...
              <tbody className="divide-y divide-slate-100 text-slate-800">
                ...
                <tr className="bg-slate-50/40 font-semibold text-slate-900">
                  <td colSpan={3} className="px-4 py-2 text-xs text-blue-700">Gross Earnings</td>
                </tr>
                <tr>
                  <td className="px-4 py-2.5 pl-6 text-slate-700">Basic Salary</td>
                ...
                <tr>
                  <td className="px-4 py-2.5 pl-6 text-slate-700">House Rent Allowance (HRA)</td>
                ...
                {salaryResult.data.monthlyOtherAllowances > 0 && (
                  <tr>
                    <td className="px-4 py-2.5 pl-6 text-slate-700">Other Allowances</td>
                ...
                {/* Deductions */}
                <tr className="bg-slate-50/40 font-semibold text-slate-900">
                  <td colSpan={3} className="px-4 py-2 text-xs text-rose-700">Standard Deductions</td>
                </tr>
                <tr>
                  <td className="px-4 py-2.5 pl-6 text-slate-700">Employee Provident Fund (EPF)</td>
                  <td className="px-4 py-2.5 text-right font-medium text-rose-600">- {formatINR(salaryResult.data.monthlyEmployeePF, { showDecimals: true })}</td>
                  <td className="px-4 py-2.5 text-right font-medium text-rose-600">- {formatINR(salaryResult.data.annualEmployeePF, { showDecimals: true })}</td>
                </tr>
                <tr>
                  <td className="px-4 py-2.5 pl-6 text-slate-700">Professional Tax (PT)</td>
                  <td className="px-4 py-2.5 text-right font-medium text-rose-600">- {formatINR(salaryResult.data.monthlyProfessionalTax, { showDecimals: true })}</td>
                  <td className="px-4 py-2.5 text-right font-medium text-rose-600">- {formatINR(salaryResult.data.annualProfessionalTax, { showDecimals: true })}</td>
                </tr>
                <tr className="bg-rose-50/50 font-semibold text-rose-950">
                ...
                {/* Net Take-Home */}
                <tr className="bg-emerald-100/60 font-bold text-emerald-950 text-sm sm:text-base">
          ...
          <div className="flex items-start gap-2.5 rounded-xl border border-amber-200 bg-amber-50/80 p-4 text-xs text-amber-900 leading-relaxed">
