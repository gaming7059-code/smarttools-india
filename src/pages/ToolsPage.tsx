    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white pl-10 pr-4 py-2 text-sm text-slate-900 placeholder-slate-400 shadow-2xs focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
          />
        </div>
      ...
      {filteredTools.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-300 p-12 text-center bg-white">
          ...
          <p className="text-slate-700 font-medium">No tools match your criteria</p>
          ...
          <button
            ...
            className="mt-4 rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-600 hover:bg-blue-100"
          >
            Clear filters
          </button>
        </div>
