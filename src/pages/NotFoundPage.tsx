...
export const NotFoundPage: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 text-center space-y-8">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 mx-auto">
        <Compass className="h-8 w-8" />
      </div>
      <div>
        <span className="text-xs font-semibold uppercase tracking-wider text-rose-600 bg-rose-50 px-2.5 py-1 rounded-full border border-rose-200">
          404 Error
        </span>
      ...
      <div className="pt-8 border-t border-slate-200 text-left max-w-xl mx-auto">
        <h2 className="text-sm font-semibold text-slate-900 uppercase tracking-wider mb-3 text-center">
